...
\newcommand{\casesection}[1]{\needspace{2\baselineskip}\vspace{.5em}\begin{center}\rmfamily\large{\bfseries{#1}}\end{center}}
% Case, etc. second heading
\newcommand{\casesubsection}[1]{\needspace{2\baselineskip}\begin{center}\rmfamily\large{\itshape{#1}}\end{center}}
